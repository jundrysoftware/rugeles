...
export class HumedadComponentComponent implements  OnDestroy, OnInit {
  chart: ChartXY;
  chartId: number;
  ...
  async getInfo() {
    this._methodsApiRestService.GetMethod('am2302.php?getinfohumedad=true&idsensor=1')
      .subscribe(
        response => {
          ...
          // Set chart title
          this.chart.setTitle('Humedad DHT22 Externo');
