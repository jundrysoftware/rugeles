...
export class Pm10ComponentComponent implements OnDestroy,  OnInit {
  chart: ChartXY;
  chartId: number;
  ...
  async getInfo() {
    this._methodsApiRestService.GetMethod('pms7003.php?getinfopm10=true&idsensor=3')
      .subscribe(
        response => {
          ...
          // Set chart title
          this.chart.setTitle('PM10.0 Externo');
